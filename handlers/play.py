...
BOT_BUTTONS = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton(text="JOIN ON MY CHANNEL", url=f"https://telegram.me/aniebots")
        ]]
    )          
...
async def playlist(client, message):
    try:
        await message._client.get_chat_member(int("-1001365784131"), message.from_user.id)
                      ...
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  ...
                                  "\n\nOr manually add @Anievcplay to your Group and try again</b>",
                              )
                              pass
    try:
        chatdetails = await USER.get_chat(chid)
